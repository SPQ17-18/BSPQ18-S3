...
public class ClientFrame extends JFrame {
	...
	private void eventos() {
		// Accedemos al evento del botón de volver del panel registro desde el
		...
		// Accedemos al evento del botón de registrarse del panel iniciar sesión
		// desde el JFrame VentanaPrincipal:
